...
@Config
@Autonomous
public class DelayedFoundationAuto extends LinearOpMode {
    ...
    public static final double[] STONES_X = {-23, -31, -39, -47, -55, -64};
...
//        LsetArm(L_ARM_STOW);
        ...
        followTrajectoryArmSync(
                drive.trajectoryBuilder()
                        ...
                        .lineTo(new Vector2d(50, -38), constInterp)
                        .build()
                , State.TO_FOUNDATION);
        drive.update();
...
//        RsetClaw(R_CLAW_STOW);
        ...
        followTrajectoryArmSync(
                drive.trajectoryBuilder()
                        .reverse()
                        .lineTo(new Vector2d(12, ALLEY_Y))
                        .lineTo(new Vector2d(STONES_X[STONE_OPTIONS[stonePos][1]],ALLEY_Y))
                        .build()
                , State.TO_QUARRY
        );
        ...
        followTrajectoryArmSync(
                drive.trajectoryBuilder()
                        .reverse()
                        .lineTo(new Vector2d(-10, ALLEY_Y))
        ...
        followTrajectoryArmSync(
                drive.trajectoryBuilder()
                        .lineTo(new Vector2d(12,ALLEY_Y))
                        .lineTo(new Vector2d(STONES_X[STONE_OPTIONS[stonePos][stoneIndex = 2]],ALLEY_Y))
                        .build()
                , State.TO_QUARRY);
        drive.update();
        ...
        followTrajectoryArmSync(
                drive.trajectoryBuilder()
                        .lineTo(new Vector2d(12,ALLEY_Y))
                        .lineTo(new Vector2d(STONES_X[STONE_OPTIONS[stonePos][stoneIndex = 3]],ALLEY_Y))
                        .build()
                , State.TO_QUARRY);
        drive.update();
...
//        strafeAndGrab(drive, -drive.getPoseEstimate().getY() - 31.5);
        ...
        followTrajectoryArmSync(
                drive.trajectoryBuilder()
                        ...
                        .splineTo(new Pose2d(50, -38, Math.toRadians(-180)))
                        .build()
                , State.TO_FOUNDATION);
        drive.update();
