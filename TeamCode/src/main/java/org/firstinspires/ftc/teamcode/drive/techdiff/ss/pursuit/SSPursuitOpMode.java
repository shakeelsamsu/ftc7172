...
//        allPoints.add(new SSCurvePoint(148, 0, 1.0, 0.3, 16, Math.toRadians(50), 1.0));
        allPoints.add(new SSCurvePoint(24, 12, 1.0, 0.3, 16, Math.toRadians(50), 1.0));
        allPoints.add(new SSCurvePoint(48, 24, 1.0, 0.3, 16, Math.toRadians(50), 1.0));
        allPoints.add(new SSCurvePoint(64, 36, 1.0, 0.3, 16, Math.toRadians(50), 1.0));
        allPoints.add(new SSCurvePoint(48, -24, 1.0, 0.3, 16, Math.toRadians(50), 1.0));
